...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-transparent h-[70px] py-[16px] lg:py-[30px] 2xl:py-[55px] flex flex-row justify-center items-center">
                        ...
                        <div
                            className={`${
                                hamburgerOpen && width <= 1024
                                    ? 'fixed flex flex-col bg-black top-0 right-0 bottom-0 w-full px-5 xs:px-14 sm:px-24 md:px-32 justify-center items-left gap-6 -mt-[400px]'
