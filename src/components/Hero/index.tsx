    ...
    return (
        <div className="px-5 xs:px-14 sm:px-24 lg:px-[30px] xl:px-[50px] 3xl:px-[90px] 3xl:pt-[173px] relative">
            <div className="absolute left-0 right-0 top-[230px] sm:top-[300px] lg:top-[407px] w-full z-30">
                ...
                <div className="hero-text lg:pl-[20%] 3xl:pl-[511px] text-[28px] xs:text-[50px] sm:text-[70px] lg:text-[127px]">Photography</div>
                <hr className="border border-white/[.5] w-[60%] mt-[11px] absolute right-0"/>
                <div className="hero-text_bottom absolute right-0 pt-[33px] lg:pr-[20%] 3xl:pr-[565px] text-[28px] xs:text-[50px] sm:text-[70px] lg:text-[127px]">as Art</div>
            </div>
